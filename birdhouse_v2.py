...
pycam.resolution = 3              # Highest supported resolution
pycam.contrast = 50               # Standard contrast (0-100)
pycam.saturation = 50             # Standard saturation (0-100)
pycam.awb_mode = "auto"           # Auto white balance
pycam.exposure_mode = "auto"      # Auto exposure
pycam.sharpness = 0               # Default sharpness (can be adjusted)
pycam.denoise = True              # Enable noise reduction
